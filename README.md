...
# Installing the Framework
    ...
    The GleanTap SDK is distributed via CocoaPods and also available as a manually installable framework for your project. You may choose any of the methods as described below Ð
...
target 'YourProjectName' do     pod 'GleanTapFramework' end 
